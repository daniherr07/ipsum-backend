...
// "Fotos_Proyecto" de cada proyecto y las liga en proyectos_photos (la
// galería general que se muestra en el módulo de búsqueda).
//
...
//
//   node scripts/linkProjectPhotos.js --commit
//
...
const SOURCE_SUBFOLDER_RAW = "Fotos_Proyecto";
const TARGET_TABLE = "proyectos_photos";
...
async function main() {
  ...
  for (const project of projects) {
    ...
    if (photoFiles.length === 0) {
      noPhotosCount++;
      console.log(`[SIN FOTOS] Proyecto "${project.nombre}": no encontré imágenes en "Fotos_Proyecto".`);
      continue;
    }
  ...
  console.log("Proyectos sin fotos en Fotos_Proyecto:", noPhotosCount);
